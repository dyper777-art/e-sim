...
class TestController extends Controller
{
    ...
    public function otherTest(Request $request){
        ...
        // $bakongKHQR->checkTransactionByMD5('21a85838d75b501b0706d709e236652c');
    ...
    public function _otherTest(Request $request)
    {
        try {
            // Initialize BakongKHQR instance with your API key
            $bakongKHQR = new BakongKHQR('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7ImlkIjoiNDE2ZTY1NWQ0ZGM3NGUwMiJ9LCJpYXQiOjE3NjQ0MDg1MTEsImV4cCI6MTc3MjE4NDUxMX0.DSCa77FRMGSPenx0t6uiyBVPaxSp0Ms7yF4Dgt53Uro');

            // Example parameters for listing transactions
            $params = [
                'fromDate' => '2025-11-01',  // start date YYYY-MM-DD
                'toDate' => '2025-11-30',    // end date YYYY-MM-DD
                'limit' => 10                // number of transactions
            ];

            // Call listTransactions
            $response = $bakongKHQR->listTransactions($params);
            ...
            // Catch errors instead of crashing with 500
            return response()->json([
                'error' => $e->getMessage()
            ], 500);
        }
